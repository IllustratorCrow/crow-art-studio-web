            ...
            <NavigationMenu className="hidden sm:block relative">
              <NavigationMenuList className="flex space-x-4">
                <NavigationMenuItem>
                  <Link
                    to="/"
                    className={`${navItemBase} ${pathname === "/" ? "bg-crow-light/10 text-crow-light" : "text-crow-text hover:bg-crow-light/10"}`}
                  >
                    Inicio
                  </Link>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                  <Link
                    to="/contacto"
                    className={`${navItemBase} ${pathname === "/contacto" ? "bg-crow-light/10 text-crow-light" : "text-crow-text hover:bg-crow-light/10"}`}
                  >
                    Contacto
                  </Link>
                </NavigationMenuItem>
