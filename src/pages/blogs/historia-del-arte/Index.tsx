...
const chapters = [
  {
    ...
    path: "/blogs/historia-del-arte/capitulo-1",
  },
...
const HistoriaDelArteIndex = () => {
  return (
    <>
      <Helmet>
        <title>Historia del Arte | Capítulos ilustrados | IllustratorCrow</title>
        <meta
          name="description"
          content="Explora la historia del arte a través de capítulos visuales e ilustrados: desde el arte prehistórico hasta las vanguardias modernas."
        />
        <meta
          name="keywords"
          content="historia del arte, arte prehistórico, capítulos de arte, ilustración, arte visual, educación artística, cantabria"
        />
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1577049090931-f8ae58117bdd?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
